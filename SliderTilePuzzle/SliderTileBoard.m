...
@implementation SliderTileBoard
...
{
    return ( [[self tileAtCoordinate:CGPointMake(coor.x, coor.y-1)] isEqualToNumber:@0] ||
             [[self tileAtCoordinate:CGPointMake(coor.x+1, coor.y)] isEqualToNumber:@0] ||
             [[self tileAtCoordinate:CGPointMake(coor.x, coor.y+1)] isEqualToNumber:@0] ||
             [[self tileAtCoordinate:CGPointMake(coor.x-1, coor.y)] isEqualToNumber:@0] );
}
