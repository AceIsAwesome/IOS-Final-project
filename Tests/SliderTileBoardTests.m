...
#import "SliderTileBoard.h"

@interface SliderTileBoardTests : XCTestCase

@property (strong, nonatomic) SliderTileBoard *board;

@end

@implementation SliderTileBoardTests

- (void)setUp
{
    [super setUp];
    
    self.board = [[SliderTileBoard alloc] initWithSize:3];
}
...
{
    XCTAssertNil([[SliderTileBoard alloc] init], @"Basic init should not return an object");
    XCTAssertNil([[SliderTileBoard alloc] initWithSize:2], @"Basic init should not return an object if size's below min");
    XCTAssertNil([[SliderTileBoard alloc] initWithSize:10], @"Basic init should not return an object if size's above max");
...
- (void)testBoardSizeAfterInit
{
    ...
    SliderTileBoard *board = [[SliderTileBoard alloc] initWithSize:5];
...
{
    SliderTileBoard *board = [[SliderTileBoard alloc] initWithSize:3];
